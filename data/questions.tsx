...
export const questions = [
  // --- DEDUPED JAVA BASICS/MULTICLASS QUESTIONS ---
  {
    ...
    correctAnswer: "True",
    explanation:
      "Java is a case-sensitive language. This means that identifiers like class names, method names, and variable names must match exactly in case. For example, `String` is a valid class name, but `string` is not.",
  },
  {
    type: "true-false",
  ...
  },
  {
    type: "short-answer",
    question:
      "Find three syntax errors in the code below. For each one, type out the entire corrected line in the answer box.\n```java\ndouble sum = 0.0\nint i;\nfor (i = 0; i < 1000; i++)\n{\n  sum == sum + i * i;\n}\nSystem.out.println(Math.round(sum / 1000));\n```",
    correctAnswer: [
      "double sum = 0.0;",
      "sum = sum + i * i;",
      "System.out.println(Math.round(sum / 1000));",
  ...
  },
  {
    ...
    correctAnswer: "x != 7",
    explanation:
      "The expression `(x == 7)` evaluates to `true` if `x` is 7, and `false` otherwise. The logical NOT operator `!` inverts this result. Therefore, `!(x == 7)` is equivalent to the 'not equal to' operator, `x != 7`.",
  },
  {
    type: "short-answer",
    question:
